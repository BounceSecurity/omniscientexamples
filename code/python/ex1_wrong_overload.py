...
def main():
    ...
    # ruleid: wrong_overload
    CatRequest.send_transaction(cat_num, 4342, msg)

    # ruleid: ok
    CatRequest.send_transaction(cat_num, 4489, "Invoice 78896", some_checksum)

    # ruleid: ok
    CatRequest.send_transaction("12146123", 4489, msg, "ABCD4123")

    # ruleid: ok
    CatRequest.send_transaction(cat_num, 4342, msg, "DEFA3456")
